...
+ A table ruralsurvey_sampledesign contains the multipliers. Merge household table with ruralsurvey_sampledesign using stratum_number field.
...
* Progress of Data Entry                                           :noexport:
