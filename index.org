...
#+BEGIN_SRC R :results silent :exports none
  ...
  addhead<-function(d1,v1,v2) {
    ...
    names(tabhead)->names(d1)[c(ncol(d1)-ncol(tabhead)+1:ncol(tabhead))]
...
| विभिन्न प्रकार का काम                          | <2colc>खंदरई |      | <2colc>गिज्जी |      | <2colc>चहर कलां |      | <2colc>जमालपुर शेखां |      | <2colc>भादस |      | <2colc>भिरढाणा |      | <2colc>भिरढाणा ढाणियाँ |      |
