...
require(data.table)
  addhead<-function(d1,v1,v2) {
        CJ(unique(v1),unique(v2))->tabhead
         ...
         levels(tabhead2[,ncol(tabhead2)])<-c(levels(tabhead2[,ncol(tabhead2)]),names(tabhead2)[length(names(tabhead2))],"")
...
#+BEGIN_SRC R :results value :exports results :colnames yes :hline yes
  ...
  t[,.(Number=length(household_number)),keyby=.(village_name,if_sc_st,caste_tribe)][CJ(unique(village_name),unique(if_sc_st),unique(caste_tribe))][,as.list(Number),by=.(if_sc_st,caste_tribe)]->t1
    ...
    names(t1)[c(3:ncol(t1))]<-unique(t$village_name)
...
| Social group | Caste          | Birdhana | Jamalpur Shekhan | Khandrai | Cheher Kalan | Gijji |
|--------------+----------------+----------+------------------+----------+--------------+-------|
| BC           | Bairagi        |      nil | nil              | 3        |          nil | nil   |
| BC           | Bhatra sikh    |      nil | nil              | nil      |            1 | nil   |
| BC           | Jhimar/Dhinwar |        1 | nil              | nil      |          nil | 3     |
| BC           | Kamboj         |        5 | nil              | nil      |            2 | nil   |
| BC           | Kamboj Sikh    |      nil | nil              | nil      |            1 | nil   |
| BC           | Khati          |      nil | 9                | nil      |            1 | 2     |
| BC           | Kumhar         |        1 | 2                | nil      |          nil | 5     |
| BC           | Lodhi          |        1 | nil              | nil      |          nil | nil   |
| BC           | Lohar          |        2 | 1                | nil      |            1 | nil   |
| BC           | Mali           |        1 | nil              | nil      |          nil | nil   |
| BC           | Nai            |        2 | 5                | nil      |            3 | nil   |
| BC           | Rebari         |       10 | nil              | nil      |          nil | nil   |
| BC           | Saini          |      nil | nil              | nil      |           14 | nil   |
| BC           | Teli           |        1 | nil              | nil      |          nil | nil   |
| Other        | Arora          |        3 | nil              | nil      |            3 | nil   |
| Other        | Baniya         |        1 | 3                | nil      |          nil | nil   |
| Other        | Bishnoi        |       11 | nil              | nil      |          nil | nil   |
| Other        | Garg           |      nil | nil              | nil      |            1 | nil   |
| Other        | Jat            |       12 | 10               | 9        |            4 | 23    |
| Other        | Jat sikh       |      nil | nil              | nil      |            4 | nil   |
| Other        | Khati          |      nil | nil              | nil      |            3 | nil   |
| Other        | Meena          |      nil | nil              | nil      |            1 | nil   |
| Other        | Mehta          |        6 | nil              | nil      |          nil | nil   |
| Other        | Sunar          |        1 | 1                | nil      |          nil | nil   |
| SC           | Balmiki        |      nil | nil              | nil      |            7 | 1     |
| SC           | Bawaria        |      nil | nil              | nil      |            1 | 1     |
| SC           | Bazigar        |        2 | nil              | nil      |            7 | nil   |
| SC           | Chamar         |       13 | 7                | 8        |            8 | 17    |
| SC           | Dhanak         |        8 | 10               | 22       |          nil | 17    |
| SC           | Mazhabi Sikh   |        1 | nil              | nil      |          nil | nil   |
| SC           | Meena          |        1 | nil              | nil      |          nil | nil   |
| SC           | Nayak          |        2 | nil              | nil      |          nil | nil   |
| SC           | Od             |        3 | nil              | nil      |           16 | nil   |
| SC           | Rai Sikh       |       15 | nil              | nil      |          nil | nil   |
...
#+BEGIN_SRC R :results value :exports results :colnames no
  household[,c(1,2,26)]->t1
  merge(member,t1,by.x="sno_id",by.y="id")->t1
  merge(t1,villages,by.x="village_id",by.y="id")->t1
  t1[as.numeric(age)>=7,.(population=length(id)),by=.(village_name,sex)]->t1
  occupations[as.numeric(age)>=7,.(numberofworkers=length(id)),by=.(village_name,occupation_category,sex)]->t
  merge(t,t1,by=c("village_name","sex"))->t
  round(t$numberofworkers*100/t$population,2)->t$numberofworkers
  ...
  names(t1)[1]<-"Occupation categories"
  addhead(t1,occupations$village_name,occupations$sex)
#+END_SRC

#+NAME: occupation
#+CAPTION: Proportion of sample population engaged in different occupations, persons aged 7 years and above, by sex and village (per cent)
#+RESULTS: occupation-table1-code
| Occupation categories                        | <2colc>Birdhana |       | <2colc>Cheher Kalan |       | <2colc>Gijji |       | <2colc>Jamalpur Shekhan |       | <2colc>Khandrai |       |
|                                              |               F |     M |                   F |     M |            F |     M |                       F |     M |               F |     M |
|----------------------------------------------+-----------------+-------+---------------------+-------+--------------+-------+-------------------------+-------+-----------------+-------|
| Landlord                                     |             nil |  0.78 |                 nil |   0.7 |          nil |   nil |                     nil |  0.48 |             nil |  0.53 |
| Peasant                                      |              12 | 28.68 |               18.55 | 32.17 |          3.9 | 13.59 |                    9.14 | 17.39 |             9.3 | 21.28 |
| Tending animals                              |            38.4 | 21.71 |               36.29 | 11.19 |        25.97 | 12.62 |                   28.49 | 15.46 |           27.91 | 13.83 |
| Agricultural labour                          |            12.4 | 11.24 |               14.52 | 19.58 |        25.97 | 19.42 |                   19.89 | 14.98 |           12.79 |  13.3 |
| Non-agricultural manual labour               |             5.6 | 15.89 |               14.52 | 13.29 |        12.99 | 15.53 |                   11.83 | 20.29 |            4.65 | 19.15 |
| Salaried government employee                 |             1.6 |  3.49 |                4.03 |   4.9 |          1.3 |   6.8 |                    1.08 |  1.45 |            4.65 |  4.26 |
| Salaried private employee                    |             0.8 | 11.24 |                0.81 |  5.59 |          1.3 | 22.33 |                     nil |  9.66 |            0.58 |  8.51 |
| Self-employed, business owner                |             0.4 | 17.44 |                1.61 | 11.89 |          1.3 | 15.53 |                    4.84 | 18.36 |            3.49 |  13.3 |
| Caste occupations/artisans                   |             2.8 |  2.71 |                4.03 |  7.69 |          nil |  2.91 |                     4.3 |  4.83 |            2.33 |   1.6 |
| Recipient of pension/remittance              |            11.2 |  8.53 |               14.52 | 11.19 |        12.99 |  8.74 |                    12.9 |  7.73 |            2.33 |   nil |
| Unemployed                                   |             nil |  0.39 |                 nil |   2.8 |          nil |  3.88 |                     nil |  0.48 |            0.58 |   nil |
| Student                                      |            26.4 | 26.36 |               25.81 | 29.37 |        27.27 | 22.33 |                   21.51 | 27.54 |           27.91 | 28.72 |
| Housework                                    |            60.8 |  1.16 |               42.74 |   3.5 |        81.82 |  5.83 |                   47.85 |  1.45 |            65.7 |  1.06 |
| Unable to work because of age or poor health |             0.8 |  1.94 |                4.03 |   3.5 |          1.3 |  3.88 |                    1.61 |  1.93 |            2.91 |  6.38 |
| Other                                        |             nil |  0.39 |                 nil |   0.7 |          nil |  1.94 |                    0.54 |  2.42 |             nil |  0.53 |
