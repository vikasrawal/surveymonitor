...
#+BEGIN_SRC R :results value :exports results :colnames yes :hline yes
  ...
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Barber"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Blacksmith"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Cobbler"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Weaver"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Dhobi/launderer"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Potmaker"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Mason"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Artisan"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Tailor"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Carpenter"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Goldsmith"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Electrician"]<-"Self-employed artisan/service provider"
  levels(occupations$occupation_category)[levels(occupations$occupation_category)=="Plumber"]<-"Self-employed artisan/service provider"
...
| Birdhana         | Self-employed artisan/service provider     |   7 |  7 |
| Birdhana         | NREGA workers/Labour in other public works |  11 |  5 |
| Birdhana         | Casual non-agricultural labour (other)     |   2 | 20 |
| Birdhana         | Salaried government employee               |   4 |  9 |
| Birdhana         | Salaried private employee                  |   2 | 17 |
| Birdhana         | Self-employed, business owner              |   1 | 42 |
...
| Birdhana         | Recipient of Pension/Remittance            |  28 | 22 |
...
| Cheher Kalan     | Self-employed artisan/service provider     |   5 | 11 |
| Cheher Kalan     | NREGA workers/Labour in other public works |   4 |  4 |
| Cheher Kalan     | Casual non-agricultural labour (other)     |   1 |  5 |
| Cheher Kalan     | Salaried government employee               |   5 |  7 |
| Cheher Kalan     | Self-employed, business owner              |   2 | 16 |
...
| Cheher Kalan     | Recipient of Pension/Remittance            |  18 | 16 |
| Gijji            | Peasant                                    |   3 | 14 |
...
| Gijji            | Salaried government employee               |   1 |  7 |
| Gijji            | Salaried private employee                  |   1 | 18 |
| Gijji            | Self-employed, business owner              |   1 | 16 |
| Gijji            | Student                                    |  23 | 30 |
| Gijji            | Housework                                  |  63 |  6 |
| Gijji            | Unable to work because of medical reasons  |   1 |  2 |
| Gijji            | Recipient of Pension/Remittance            |  10 |  9 |
| Jamalpur Shekhan | Peasant                                    |  17 | 36 |
| Jamalpur Shekhan | Tending animals                            |  53 | 32 |
| Jamalpur Shekhan | Agricultural labour                        |  36 | 31 |
| Jamalpur Shekhan | Self-employed artisan/service provider     |   8 | 10 |
...
| Jamalpur Shekhan | Salaried government employee               |   2 |  3 |
| Jamalpur Shekhan | Self-employed, business owner              |   9 | 34 |
...
| Jamalpur Shekhan | Recipient of Pension/Remittance            |  24 | 16 |
| Khandrai         | Peasant                                    |  16 | 40 |
| Khandrai         | Tending animals                            |  48 | 26 |
| Khandrai         | Agricultural labour                        |  22 | 24 |
| Khandrai         | Self-employed artisan/service provider     |   4 |  3 |
...
| Khandrai         | Salaried government employee               |   8 |  8 |
| Khandrai         | Salaried private employee                  |   1 | 12 |
| Khandrai         | Self-employed, business owner              |   6 | 24 |
