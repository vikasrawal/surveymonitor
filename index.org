...
#+BEGIN_SRC R :results value :exports results :colnames no :hline no
  ...
  ifelse(!is.na(tabhead$V1),paste("<",tabhead$len,"colc>",tabhead$V1,sep=""),NA)->tabhead$V1
...
| nil                                          | Birdhana | Birdhana | Cheher Kalan | Cheher Kalan | Gijji | Gijji | Jamalpur Shekhan | Jamalpur Shekhan | Khandrai | Khandrai |
