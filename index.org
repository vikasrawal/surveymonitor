...
#+BEGIN_SRC R :results value :exports results :colnames no :hline no
  occupations[,.(numberofworkers=length(id)),keyby=.(village_name,occupation_category,sex)]->t
  t[CJ(unique(village_name),unique(occupation_category),unique(sex))][,as.list(numberofworkers),by=.(occupation_category)]->t
  #transpose(CJ(unique(occupations$village_name),unique(occupations$sex)))->name
  function(v1,v2) {

  CJ(unique(occupations$village_name),unique(occupations$sex))->tabhead
  ...
  as.data.frame(rbind(tabhead,t,fill=TRUE))->t
  levels(t[ncol(t)])
  names(t)[length(names(t))]->t[1,ncol(t)]
  t[,c(ncol(t),1:ncol(t)-1)]
...
| nil                                          | <2colc>Birdhana |    | <2colc>Cheher Kalan |    | <2colc>Gijji |     | <2colc>Jamalpur Shekhan |    | <2colc>Khandrai |     |
| nil                                          |               F |  M |                   F |  M |            F |   M |                       F |  M |               F |   M |
|----------------------------------------------+-----------------+----+---------------------+----+--------------+-----+-------------------------+----+-----------------+-----|
| Landlord                                     |             nil |  2 |                 nil |  1 |          nil | nil |                     nil |  1 |             nil |   1 |
| Peasant                                      |              31 | 74 |                  23 | 46 |            3 |  14 |                      17 | 36 |              16 |  40 |
| Tending animals                              |              97 | 56 |                  45 | 16 |           20 |  13 |                      53 | 32 |              48 |  26 |
| Agricultural labour                          |              31 | 29 |                  18 | 28 |           20 |  20 |                      37 | 31 |              22 |  25 |
| Non-agricultural manual labour               |              14 | 41 |                  18 | 19 |           10 |  16 |                      22 | 42 |               8 |  36 |
| Salaried government employee                 |               4 |  9 |                   5 |  7 |            1 |   7 |                       2 |  3 |               8 |   8 |
| Salaried private employee                    |               2 | 29 |                   1 |  8 |            1 |  23 |                     nil | 20 |               1 |  16 |
| Self-employed, business owner                |               1 | 45 |                   2 | 17 |            1 |  16 |                       9 | 38 |               6 |  25 |
| Caste occupations/artisans                   |               7 |  7 |                   5 | 11 |          nil |   3 |                       8 | 10 |               4 |   3 |
| Recipient of pension/remittance              |              28 | 22 |                  18 | 16 |           10 |   9 |                      24 | 16 |               4 | nil |
| Unemployed                                   |             nil |  1 |                 nil |  4 |          nil |   4 |                     nil |  1 |               1 | nil |
| Student                                      |              85 | 91 |                  39 | 50 |           23 |  31 |                      47 | 68 |              53 |  68 |
| Housework                                    |             153 |  3 |                  54 |  5 |           63 |   6 |                      90 |  3 |             113 |   2 |
| Unable to work because of age or poor health |               2 |  5 |                   5 |  5 |            1 |   4 |                       3 |  4 |               5 |  12 |
| Other                                        |             nil |  1 |                 nil |  1 |          nil |   2 |                       1 |  5 |             nil |   1 |
